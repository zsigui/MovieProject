...
package com.jackiez.base.assist.multi_type;
...
public abstract class ItemViewProvider<T, V extends ViewHolder> {
    ...
    // 此处修改原来的接口，添加 position，使得能够通过 Provider 设置共享回调事件
    protected abstract void onBindViewHolder(@NonNull V holder, @NonNull T t, @NonNull int position);
